...
var a = (() => {
  ...
  ve = i(/link|precode-code|html/, `g`)
    ...
    .replace(`html`, /<(?! )[^<>]*?>/)
    .getRegex(),
  S = /^(?:\*+(?:((?!\*)punct)|([^\s*]))?)|^_+(?:((?!_)punct)|([^\s_]))?/,
  C = i(S, `u`).replace(/punct/g, v).getRegex(),
  ye = i(S, `u`).replace(/punct/g, b).getRegex(),
  ...
  Oe = i(/^!?\[(ref)\](?:\[\])?/)
    .replace(`ref`, ie)
    .getRegex(),
  ke = i(`reflink|nolink(?!\\()`, `g`)
    .replace(`reflink`, O)
    .replace(`nolink`, Oe)
    .getRegex(),
  Ae = /[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,
  k = {
    _backpedal: r,
    anyPunctuation: we,
    autolink: E,
  ...
  j = {
    ...
    delLDelim: Ce,
    delRDelim: T,
    url: i(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/)
      .replace(`protocol`, Ae)
      .replace(
        `email`,
  ...
  je = {
    ...j,
    br: i(pe).replace(`{2,}`, `*`).getRegex(),
    text: i(j.text)
      .replace(`\\b_`, `\\b_| {2,}\\n`)
      .replace(/\{2,\}/g, `*`)
      .getRegex(),
  },
  M = { normal: ce, gfm: _, pedantic: ue },
  N = { normal: k, gfm: j, breaks: je, pedantic: A },
  Me = { "&": `&amp;`, "<": `&lt;`, ">": `&gt;`, '"': `&quot;`, "'": `&#39;` },
  Ne = (e) => Me[e];
function P(e, t) {
  if (t) {
    if (o.escapeTest.test(e)) return e.replace(o.escapeReplace, Ne);
  } else if (o.escapeTestNoEncode.test(e))
    return e.replace(o.escapeReplaceNoEncode, Ne);
  return e;
}
function F(e) {
  try {
...
`
    ...
    reflink(e, t) {
      ...
      if (
        ...
        return Ie(n, e, n[0], this.lexer, this.rules);
      }
    }
    emStrong(e, t, n = ``) {
  ...
  z = class e {
    ...
    constructor(e) {
      ...
      let n = { other: o, block: M.normal, inline: N.normal };
      (this.options.pedantic
          ...
          if (e.hooks) {
            ...
            for (let n in e.hooks) {
              ...
              let r = n,
                i = e.hooks[r],
                a = t[r];
              H.passThroughHooks.has(n)
                ? (t[r] = (e) => {
                    if (
                      this.defaults.async &&
                      H.passThroughHooksRespectAsync.has(n)
                    )
                      return (async () => {
    ...
    parseMarkdown(e) {
      return (t, n) => {
        ...
        try {
          ...
          let r = (
            i.hooks ? i.hooks.provideParser() : e ? V.parse : V.parseInline
          )(n, i);
...
Please report this to https://github.com/markedjs/marked.`),
          ...
          let e =
            `<p>An error occurred:</p><pre>` + P(n.message + ``, !0) + `</pre>`;
...
((W.options = W.setOptions =
  function (e) {
    return (U.setOptions(e), (W.defaults = U.defaults), n(W.defaults), W);
  }),
  (W.getDefaults = e),
  (W.defaults = t),
  (W.use = function (...e) {
    return (U.use(...e), (W.defaults = U.defaults), n(W.defaults), W);
  }),
  (W.walkTokens = function (e, t) {
    return U.walkTokens(e, t);
  }),
  (W.parseInline = U.parseInline),
  (W.Parser = V),
  (W.parser = V.parse),
  (W.Renderer = B),
  (W.TextRenderer = Re),
...
var {
  ...
  { freeze: G, seal: K, create: We } = Object,
  { apply: q, construct: Ge } = typeof Reflect < `u` && Reflect;
((G ||= function (e) {
  return e;
}),
  (K ||= function (e) {
...
var Ke = X(Array.prototype.forEach),
  qe = X(Array.prototype.lastIndexOf),
  Je = X(Array.prototype.pop),
  Ye = X(Array.prototype.push),
  Xe = X(Array.prototype.splice),
  Ze = X(String.prototype.toLowerCase),
  Qe = X(String.prototype.toString),
  $e = X(String.prototype.match),
  et = X(String.prototype.replace),
  tt = X(String.prototype.indexOf),
  nt = X(String.prototype.trim),
  J = X(Object.prototype.hasOwnProperty),
...
var st = G(
  ...
  _t = G([`xlink:href`, `xml:id`, `xlink:title`, `xml:space`, `xmlns:xlink`]),
  $ = K(/\{\{[\w\W]*|[\w\W]*\}\}/gm),
  vt = K(/<%[\w\W]*|[\w\W]*%>/gm),
  yt = K(/\$\{[\w\W]*/gm),
  bt = K(/^data-[\-\w.\u00B7-\uFFFF]+$/),
...
function Mt() {
  ...
  if (
    ((t.version = `3.3.3`),
    (t.removed = []),
    !e || !e.document || e.document.nodeType !== Ot.document || !e.Element)
  )
  ...
  let {
    ...
    M = null,
    N = Z({}, [`audio`, `video`, `img`, `source`, `image`, `track`]),
    Me = null,
    Ne = Z({}, [
      `alt`,
      `class`,
    ...
    P = `http://www.w3.org/1998/Math/MathML`,
    ...
    Fe = null,
    Ie = Z({}, [P, F, I], Qe),
    Le = Z({}, [`mi`, `mo`, `mn`, `ms`, `mtext`]),
    R = Z({}, [`annotation-xml`]),
    z = Z({}, [`title`, `style`, `font`, `a`, `script`]),
    B = null,
    Re = [`application/xhtml+xml`, `text/html`],
    V = null,
    H = null,
    U = n.createElement(`form`),
    W = function (e) {
    ...
    Be = function () {
      ...
      if (!(H && H === e)) {
        if (
          ...
          (e = Q(e)),
          (B =
            Re.indexOf(e.PARSER_MEDIA_TYPE) === -1
              ? `text/html`
              : e.PARSER_MEDIA_TYPE),
          (V = B === `application/xhtml+xml` ? Qe : Ze),
          (b = J(e, `ALLOWED_TAGS`) ? Z({}, e.ALLOWED_TAGS, V) : _e),
          (x = J(e, `ALLOWED_ATTR`) ? Z({}, e.ALLOWED_ATTR, V) : ve),
          (Fe = J(e, `ALLOWED_NAMESPACES`)
            ? Z({}, e.ALLOWED_NAMESPACES, Qe)
            : Ie),
          (Me = J(e, `ADD_URI_SAFE_ATTR`)
            ? Z(Q(Ne), e.ADD_URI_SAFE_ATTR, V)
            : Ne),
          (M = J(e, `ADD_DATA_URI_TAGS`) ? Z(Q(N), e.ADD_DATA_URI_TAGS, V) : N),
          (j = J(e, `FORBID_CONTENTS`) ? Z({}, e.FORBID_CONTENTS, V) : je),
          (C = J(e, `FORBID_TAGS`) ? Z({}, e.FORBID_TAGS, V) : Q({})),
          (ye = J(e, `FORBID_ATTR`) ? Z({}, e.FORBID_ATTR, V) : Q({})),
          (A = J(e, `USE_PROFILES`) ? e.USE_PROFILES : !1),
          (be = e.ALLOW_ARIA_ATTR !== !1),
          (xe = e.ALLOW_DATA_ATTR !== !1),
          (Se = e.ALLOW_UNKNOWN_PROTOCOLS || !1),
          (Ce = e.ALLOW_SELF_CLOSE_IN_ATTR !== !1),
          (T = e.SAFE_FOR_TEMPLATES || !1),
          (we = e.SAFE_FOR_XML !== !1),
          (E = e.WHOLE_DOCUMENT || !1),
          (D = e.RETURN_DOM || !1),
          (De = e.RETURN_DOM_FRAGMENT || !1),
          (O = e.RETURN_TRUSTED_TYPE || !1),
          (Ee = e.FORCE_BODY || !1),
          (Oe = e.SANITIZE_DOM !== !1),
          (ke = e.SANITIZE_NAMED_PROPS || !1),
          (Ae = e.KEEP_CONTENT !== !1),
          (k = e.IN_PLACE || !1),
          (ge = e.ALLOWED_URI_REGEXP || St),
          (L = e.NAMESPACE || I),
          (Le = e.MATHML_TEXT_INTEGRATION_POINTS || Le),
          (R = e.HTML_INTEGRATION_POINTS || R),
          (S = e.CUSTOM_ELEMENT_HANDLING || {}),
          e.CUSTOM_ELEMENT_HANDLING &&
            W(e.CUSTOM_ELEMENT_HANDLING.tagNameCheck) &&
            (S.tagNameCheck = e.CUSTOM_ELEMENT_HANDLING.tagNameCheck),
          e.CUSTOM_ELEMENT_HANDLING &&
            W(e.CUSTOM_ELEMENT_HANDLING.attributeNameCheck) &&
          ...
          A &&
            ((b = Z({}, pt)),
            (x = We(null)),
            A.html === !0 && (Z(b, st), Z(x, mt)),
            A.svg === !0 && (Z(b, ct), Z(x, ht), Z(x, _t)),
            A.svgFilters === !0 && (Z(b, lt), Z(x, ht), Z(x, _t)),
            A.mathMl === !0 && (Z(b, dt), Z(x, gt), Z(x, _t))),
          J(e, `ADD_TAGS`) || (w.tagCheck = null),
          J(e, `ADD_ATTR`) || (w.attributeCheck = null),
          e.ADD_TAGS &&
            (typeof e.ADD_TAGS == `function`
              ? (w.tagCheck = e.ADD_TAGS)
              : (b === _e && (b = Q(b)), Z(b, e.ADD_TAGS, V))),
          e.ADD_ATTR &&
            (typeof e.ADD_ATTR == `function`
              ? (w.attributeCheck = e.ADD_ATTR)
              : (x === ve && (x = Q(x)), Z(x, e.ADD_ATTR, V))),
          e.ADD_URI_SAFE_ATTR && Z(Me, e.ADD_URI_SAFE_ATTR, V),
          e.FORBID_CONTENTS &&
            (j === je && (j = Q(j)), Z(j, e.FORBID_CONTENTS, V)),
          e.ADD_FORBID_CONTENTS &&
            (j === je && (j = Q(j)), Z(j, e.ADD_FORBID_CONTENTS, V)),
          Ae && (b[`#text`] = !0),
          E && Z(b, [`html`, `head`, `body`]),
          b.table && (Z(b, [`tbody`]), delete C.tbody),
          ...
          ((m = e.TRUSTED_TYPES_POLICY), (h = m.createHTML(``)));
        } else
          (m === void 0 && (m = At(f, i)),
            m !== null && typeof h == `string` && (h = m.createHTML(``)));
        (G && G(e), (H = e));
      }
    },
    Ve = Z({}, [...ct, ...lt, ...ut]),
    ...
    Ue = function (e) {
      let t = ae(e);
      (!t || !t.tagName) && (t = { namespaceURI: L, tagName: `template` });
      let n = Ze(e.tagName),
        r = Ze(t.tagName);
          ...
          : e.namespaceURI === P
            ? t.namespaceURI === I
              ...
              : t.namespaceURI === F
                ...
                : !!He[n]
            : e.namespaceURI === I
              ? (t.namespaceURI === F && !R[r]) ||
                (t.namespaceURI === P && !Le[r])
                ? !1
                : !He[n] && (z[n] || !Ve[n])
              : !!(B === `application/xhtml+xml` && Fe[e.namespaceURI])
        : !1;
    },
    K = function (e) {
      Ye(t.removed, { element: e });
      try {
        ae(e).removeChild(e);
      } catch {
        ne(e);
    ...
    q = function (e, n) {
      try {
        Ye(t.removed, { attribute: n.getAttributeNode(e), from: n });
      } catch {
        Ye(t.removed, { attribute: null, from: n });
      }
    ...
    Ge = function (e) {
      ...
      B === `application/xhtml+xml` &&
        ...
        (e =
          ...
          e +
          `</body></html>`);
      let i = m ? m.createHTML(e) : e;
      if (L === I)
        try {
          t = new ee().parseFromString(i, B);
        } catch {}
      if (!t || !t.documentElement) {
        t = g.createDocument(L, `template`, null);
        try {
          t.documentElement.innerHTML = Pe ? h : i;
        } catch {}
      }
      let a = t.body || t.documentElement;
      return (
        e && r && a.insertBefore(n.createTextNode(r), a.childNodes[0] || null),
        L === I ? ce.call(t, E ? `html` : `body`)[0] : E ? t.documentElement : a
      );
    },
    X = function (e) {
      return oe.call(
  ...
  let vt = function (e) {
      let n = null;
      if (($(_.beforeSanitizeElements, e, null), it(e))) return (K(e), !0);
      let r = V(e.nodeName);
      if (
        ($(_.uponSanitizeElement, e, { tagName: r, allowedTags: b }),
        (we &&
          e.hasChildNodes() &&
          !at(e.firstElementChild) &&
          Y(/<[/\w!]/g, e.innerHTML) &&
          Y(/<[/\w!]/g, e.textContent)) ||
          e.nodeType === Ot.progressingInstruction ||
          (we && e.nodeType === Ot.comment && Y(/<[/\w]/g, e.data)))
      )
        return (K(e), !0);
      if (
        !(w.tagCheck instanceof Function && w.tagCheck(r)) &&
        (!b[r] || C[r])
      ) {
        if (
          !C[r] &&
          bt(r) &&
          ((S.tagNameCheck instanceof RegExp && Y(S.tagNameCheck, r)) ||
            (S.tagNameCheck instanceof Function && S.tagNameCheck(r)))
        )
          return !1;
        if (Ae && !j[r]) {
          let t = ae(e) || e.parentNode,
            n = ie(e) || e.childNodes;
          if (n && t) {
            let r = n.length;
            for (let i = r - 1; i >= 0; --i) {
      ...
      return (e instanceof c && !Ue(e)) ||
        ...
        : (T &&
            ...
            e.textContent !== n &&
              (Ye(t.removed, { element: e.cloneNode() }), (e.textContent = n))),
          $(_.afterSanitizeElements, e, null),
          !1);
    },
    yt = function (e, t, r) {
      if (ye[t] || (Oe && (t === `id` || t === `name`) && (r in n || r in U)))
        return !1;
      if (
        !(xe && !ye[t] && Y(pe, t)) &&
        !(be && Y(me, t)) &&
        ...
        if (!x[t] || ye[t]) {
          if (
            !(
              (bt(e) &&
                ((S.tagNameCheck instanceof RegExp && Y(S.tagNameCheck, e)) ||
                  (S.tagNameCheck instanceof Function && S.tagNameCheck(e))) &&
                ((S.attributeNameCheck instanceof RegExp &&
                  Y(S.attributeNameCheck, t)) ||
                  (S.attributeNameCheck instanceof Function &&
                    S.attributeNameCheck(t, e)))) ||
              (t === `is` &&
                S.allowCustomizedBuiltInElements &&
                ((S.tagNameCheck instanceof RegExp && Y(S.tagNameCheck, r)) ||
                  (S.tagNameCheck instanceof Function && S.tagNameCheck(r))))
    ...
    bt = function (e) {
      return e !== `annotation-xml` && $e(e, he);
    },
    xt = function (e) {
    ...
    Ct = function e(t) {
      let n = null,
        r = X(t);
      for ($(_.beforeSanitizeShadowDOM, t, null); (n = r.nextNode()); )
        ($(_.uponSanitizeShadowNode, n, null),
          vt(n),
          xt(n),
  ...
  return (
    (t.sanitize = function (e) {
      let n =
        ...
        c = null,
        l = null;
      if (((Pe = !e), Pe && (e = `<!-->`), typeof e != `string` && !at(e)))
      ...
      if (
        (Te || Be(n), (t.removed = []), typeof e == `string` && (k = !1), k)
      ) {
        if (e.nodeName) {
          let t = V(e.nodeName);
          if (!b[t] || C[t])
        ...
        ((i = Ge(`<!---->`)),
          ...
          (o.nodeType === Ot.element && o.nodeName === `BODY`) ||
          o.nodeName === `HTML`
            ? (i = o)
            : i.appendChild(o));
      else {
        if (!D && !T && !E && e.indexOf(`<`) === -1)
          return m && O ? m.createHTML(e) : e;
        if (((i = Ge(e)), !i)) return D ? null : O ? h : ``;
      }
      i && Ee && K(i.firstChild);
      let u = X(k ? e : i);
      for (; (c = u.nextNode()); )
        (vt(c), xt(c), c.content instanceof a && Ct(c.content));
      if (k) return e;
      if (D) {
        if (De)
        ...
        return (
          (x.shadowroot || x.shadowrootmode) && (l = le.call(r, l, !0)),
          l
        );
      }
      ...
      return (
        E &&
          ...
          Y(Tt, i.ownerDocument.doctype.name) &&
          (d =
            `<!DOCTYPE ` +
            i.ownerDocument.doctype.name +
            `>
` +
        ...
        m && O ? m.createHTML(d) : d
      );
    }),
    (t.setConfig = function () {
      (Be(arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}),
        (Te = !0));
    }),
    ...
    (t.isValidAttribute = function (e, t, n) {
      return (H || Be({}), yt(V(e), V(t), n));
    }),
    (t.addHook = function (e, t) {
      typeof t == `function` && Ye(_[e], t);
    }),
    (t.removeHook = function (e, t) {
      if (t !== void 0) {
        let n = qe(_[e], t);
        return n === -1 ? void 0 : Xe(_[e], n, 1)[0];
      }
      return Je(_[e]);
    }),
...
function Ft(e) {
  let t = document.getElementById(`lamp-button`),
    n = document.querySelector(`.lamp-text`),
    r = document.getElementById(`user-input`),
    i = document.getElementById(`output-container`);
  ((t.disabled = e),
    e
      ? (i.classList.add(`hidden`),
        ...
        (n.textContent = `Summoning Gift Ideas...`))
      : (i.classList.remove(`hidden`),
        i.classList.add(`visible`),
        t.classList.remove(`loading`),
        t.classList.add(`compact`),
        (n.textContent = `Rub the Lamp`)));
}
var It = document.getElementById(`gift-form`),
  Lt = document.getElementById(`user-input`),
  Rt = document.getElementById(`output-content`);
function zt() {
  (Lt.addEventListener(`input`, () => Pt(Lt)),
    It.addEventListener(`submit`, Bt));
}
async function Bt(e) {
  e.preventDefault();
  let t = Lt.value.trim();
      ...
      let e = (
          await (
            await fetch(`/api/gift`, {
              ...
              body: JSON.stringify({ userPrompt: t }),
            })
          ).json()
        ).message,
        n = W.parse(e);
      Rt.innerHTML = Nt.sanitize(n);
    } catch (e) {
      (e.status === 429 &&
        (Rt.textContent = `retry after delay or show message to user`),
        console.error(e),
        (Rt.textContent = `Something went wrong. Check the console.`));
    } finally {
      Ft(!1);
    }
  }
